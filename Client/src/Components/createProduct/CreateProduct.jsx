...
export default function CreateProduct() {
  ...
  useEffect(() => {
    if (isEditing) {
      ...
      const categoryId = categ.find(
        (item) => item.name === productData.category || item.id === productData.category,
      );
        ...
        <>
          <div className={style.productCont}>
            <div className={style.imgCont}>
              {imageUrl !== '' ? (
                <button className={style.closeImgBtn}>
                  <span className='material-icons' onClick={handleImageDelete}>
                    close
                  </span>
                </button>
              ) : null}
            ...
            <div className={style.infoProduct}>
              ...
              <div className={style.priceAndCatContainer}>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className={style.productCategories}
                >
                  <option className={style.casillero} value='Todos'>
              ...
              <div className={style.stockContainer}>
                <p className={style.dollarSign}>Stock:</p>
                <input
                  name='stock'
                  onChange={handleInputChange}
